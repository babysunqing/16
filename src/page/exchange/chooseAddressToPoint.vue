...
export default {
  ...
  methods:{
    ...
    choose:function(item){
      ...
      this.$router.replace({name: 'takeGoodsFromPoint', params: {rootOrder: JSON.stringify(this.rootOrder),goodsDetail: JSON.stringify(this.goodsDetail),address:JSON.stringify(item)}})
    }  
  }
}
</script> 
